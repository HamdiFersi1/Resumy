  ...
  reducers: {
    ...
    changeWorkExperiences: (
      ...
      if (field === "descriptions") {
        workExperience.descriptions = value as string[];
      } else {
        workExperience[field] = value as string;
      }
    },
    changeEducations: (
      draft,
      ...
      if (field === "descriptions") {
        education.descriptions = value as string[];
      } else {
    ...
    changeProjects: (
      ...
      if (field === "descriptions") {
        project.descriptions = value as string[];
      } else {
    ...
    setResume: (_state, action: PayloadAction<Resume>) => {
      return action.payload;
    },
    clearResume: () => initialResumeState,
